...
/*Tab A9 code for AX6739A-2864 by suyurui at 20240826 start*/
#if !defined(CONFIG_ODM_CUSTOM_FACTORY_BUILD) && defined(SX933X_ANFR_LOGIC)
const int g_irq_maxnum = 60;
...
/*Tab A9 code for AX6739A-2864 by suyurui at 20240826 end*/
...
static void smtc_anfr_irq(Self self)
{
    ...
    if (((prox_state >> 27) & 1) != gs_last_state) {
        g_irq_count++;
        gs_last_state = (prox_state >> 27) & 1;
