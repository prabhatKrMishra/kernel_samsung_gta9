...
#include "a0901frontsc201csly_mipi_raw.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "a0901frontsc201csly_mipi_raw"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = A0901_FRONT_SC201CSLY_SENSOR_ID,
    ...
    .checksum_value = 0x820e0cf,        //checksum value for Camera Auto Test
		...
		.pre = {
			...
			.max_framerate = 300,
			.mipi_pixel_rate = 72000000,//720Mbps x1/10
	},
		.cap = {
			.pclk = 72000000,
			.linelength = 1920,
...
{
	return ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108)); //0xeb2c
}
...
*
* DESCRIPTION
*   This function is to set Frame sync for slave sensor
*
*
* GLOBALS AFFECTED
*
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    pr_debug("Gain_Debug pass_gain= %d\n",gain);
...
static void sensor_init(void)
{
    ...
    //Resolution: 1600(H)x1200(V)_30fps
    //MCLK=24M
    //MIPI速率：720Mbps
    //1 lane no-continue, RAW 10
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            pr_debug("liluling Read sensor id fail, id: 0x%x,sensor_id:0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
static kal_uint32 open(void)
{
	...
	pr_debug("SC201CS,MIPI 1LANE\n");
	pr_debug("preview 1600*1200@30fps,864Mbps/lane; video 1600*1200@30fps,864Mbps/lane; capture 2M@30fps,864Mbps/lane\n");
     ...
     pr_debug("liluling i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
...
UINT32 A0901FRONTSC201CSLY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
