...
/*Tab A9 code for SR-AX6739A-01-471 by hualei at 20230508 start*/
...
/*Tab A9 code for SR-AX6739A-01-471 by hualei at 20230508 end*/
...
/*Tab A9 code for AX6739A-2389|AX6739A-2638 by lina at 20230808 start*/
extern const AW_U8 aw35615_reg_access[AW35615_REG_MAX];
static int debug_reg_show(void)
{
    int ret = 0;
    AW_U8 val = 0;
    AW_U8 i = 0;
...
/*Tab A9 code for AX6739A-2389|AX6739A-2638 by lina at 20230808 end*/
...
static void aw35615_init_delay_work(struct work_struct *work)
{
     ...
     */
    aw_InitializeCore();
    /*Tab A9 code for AX6739A-1452 by lina at 20230627 start*/
    mdelay(50);
    /*Tab A9 code for AX6739A-1452 by lina at 20230627 end*/
    ...
    /*Tab A9 code for AX6739A-1452|AX6739A-2389 by lina at 20230725 start*/
    pr_err("platform_get_device_irq_state:%d\n", platform_get_device_irq_state(chip->port.PortID));
    if (platform_get_device_irq_state(chip->port.PortID)) {
        /* Plug-in typec power-on interrupt detection */
        pr_err("chip->queued=%d\n", chip->queued);
        if (!chip->queued) {
            chip->queued = AW_TRUE;
            pr_err("Plug-in typec power-on interrupt detection\n");
...
static int aw35615_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    /*Tab A9 code for SR-AX6739A-01-471 by hualei at 20230508 start*/
    /* set for tcpc_info */
    gxy_bat_set_tcpcinfo(GXY_BAT_TCPC_INFO_AW35615);
    /*Tab A9 code for SR-AX6739A-01-471 by hualei at 20230508 end*/
...
static void aw35615_shutdown(struct i2c_client *client)
{
    ...
    mdelay(25);
    /*Tab A9 code for AX6739A-2500 by liufurong at 20230725 end*/
    ...
    /*Tab A9 code for AX6739A-516 | AX6739A-1416 by wenyaqi at 20230621 start*/
    //SetStateUnattached(&chip->port);
    /*Tab A9 code for AX6739A-516 | AX6739A-1416 by wenyaqi at 20230621 end*/
